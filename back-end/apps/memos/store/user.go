...
const (
	SystemBotID int32 = 0
	// BuiltinAdminID is the sole instance admin created by EnsureBuiltinAdmin.
	BuiltinAdminID int32 = 1
	// BuiltinAdminUsername is the fixed username (and initial nickname) for BuiltinAdminID.
