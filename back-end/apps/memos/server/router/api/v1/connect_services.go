...
func (s *ConnectServiceHandler) CreateDriftBottle(ctx context.Context, req *connect.Request[v1pb.CreateDriftBottleRequest]) (*connect.Response[v1pb.DriftBottle], error) {
	resp, err := s.APIV1Service.CreateDriftBottle(ctx, req.Msg)
	if err != nil {
		return nil, convertGRPCError(err)
	}
	return connect.NewResponse(resp), nil
...
func (s *ConnectServiceHandler) GetDriftBottle(ctx context.Context, req *connect.Request[v1pb.GetDriftBottleRequest]) (*connect.Response[v1pb.DriftBottle], error) {
	resp, err := s.APIV1Service.GetDriftBottle(ctx, req.Msg)
	if err != nil {
		return nil, convertGRPCError(err)
	}
	return connect.NewResponse(resp), nil
...
func (s *ConnectServiceHandler) PickDriftBottle(ctx context.Context, req *connect.Request[v1pb.PickDriftBottleRequest]) (*connect.Response[v1pb.PickDriftBottleResponse], error) {
	resp, err := s.APIV1Service.PickDriftBottle(ctx, req.Msg)
	if err != nil {
		return nil, convertGRPCError(err)
	}
	return connect.NewResponse(resp), nil
...
func (s *ConnectServiceHandler) RefreshMyDriftBottleCandidates(ctx context.Context, req *connect.Request[v1pb.RefreshMyDriftBottleCandidatesRequest]) (*connect.Response[v1pb.RefreshMyDriftBottleCandidatesResponse], error) {
	resp, err := s.APIV1Service.RefreshMyDriftBottleCandidates(ctx, req.Msg)
	if err != nil {
		return nil, convertGRPCError(err)
	}
	return connect.NewResponse(resp), nil
...
func (s *ConnectServiceHandler) SearchDriftBottles(ctx context.Context, req *connect.Request[v1pb.SearchDriftBottlesRequest]) (*connect.Response[v1pb.SearchDriftBottlesResponse], error) {
	resp, err := s.APIV1Service.SearchDriftBottles(ctx, req.Msg)
	if err != nil {
		return nil, convertGRPCError(err)
	}
	return connect.NewResponse(resp), nil
...
func (s *ConnectServiceHandler) ReplyDriftBottle(ctx context.Context, req *connect.Request[v1pb.ReplyDriftBottleRequest]) (*connect.Response[v1pb.Memo], error) {
	resp, err := s.APIV1Service.ReplyDriftBottle(ctx, req.Msg)
	if err != nil {
		return nil, convertGRPCError(err)
	}
	return connect.NewResponse(resp), nil
