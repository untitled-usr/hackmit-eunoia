...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\bpassword\x18\b \x01(\tB\x06\xe0A\x04\xe0A\x01R\bpassword\x12.\n" +
	...
	"updateTime\x12\x1b\n" +
	"\x06gender\x18\f \x01(\tB\x03\xe0A\x01R\x06gender\x12\x15\n" +
	"\x03age\x18\r \x01(\x05B\x03\xe0A\x01R\x03age\"1\n" +
	"\x04Role\x12\x14\n" +
	"\x10ROLE_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05ADMIN\x10\x02\x12\b\n" +
	"\x04USER\x10\x03:7\xeaA4\n" +
	"\x11memos.api.v1/User\x12\fusers/{user}\x1a\x04name*\x05users2\x04userJ\x04\b\x04\x10\x05R\x05email\"\x9d\x01\n" +
	...
	"\tread_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\breadMask\"\xbd\x01\n" +
	"\x11CreateUserRequest\x123\n" +
	"\x04user\x18\x01 \x01(\v2\x12.memos.api.v1.UserB\x06\xe0A\x01\xe0A\x04H\x00R\x04user\x88\x01\x01\x12\x1c\n" +
	"\auser_id\x18\x02 \x01(\tB\x03\xe0A\x01R\x06userId\x12(\n" +
	"\rvalidate_only\x18\x03 \x01(\bB\x03\xe0A\x01R\fvalidateOnly\x12\"\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\x03\xe0A\x01R\trequestIdB\a\n" +
	"\x05_user\"\xac\x01\n" +
	...
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\xda\x01\n" +
	...
	"\x1dmemos.api.v1/UserNotificationR\x04name2\xe0\x12\n" +
	"\vUserService\x12c\n" +
	...
	"\aGetUser\x12\x1c.memos.api.v1.GetUserRequest\x1a\x12.memos.api.v1.User\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v1/{name=users/*}\x12[\n" +
	"\n" +
	"CreateUser\x12\x1f.memos.api.v1.CreateUserRequest\x1a\x12.memos.api.v1.User\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/api/v1/users\x12\x7f\n" +
	"\n" +
	...
	"\x10ListUserSettings\x12%.memos.api.v1.ListUserSettingsRequest\x1a&.memos.api.v1.ListUserSettingsResponse\"2\xdaA\x06parent\x82\xd3\xe4\x93\x02#\x12!/api/v1/{parent=users/*}/settings\x12\x95\x01\n" +
...
var file_api_v1_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_api_v1_user_service_proto_goTypes = []any{
	...
	(*UserWebhook)(nil),                         // 20: memos.api.v1.UserWebhook
	(*ListUserWebhooksRequest)(nil),             // 21: memos.api.v1.ListUserWebhooksRequest
	(*ListUserWebhooksResponse)(nil),            // 22: memos.api.v1.ListUserWebhooksResponse
	(*CreateUserWebhookRequest)(nil),            // 23: memos.api.v1.CreateUserWebhookRequest
	(*UpdateUserWebhookRequest)(nil),            // 24: memos.api.v1.UpdateUserWebhookRequest
	(*DeleteUserWebhookRequest)(nil),            // 25: memos.api.v1.DeleteUserWebhookRequest
	(*UserNotification)(nil),                    // 26: memos.api.v1.UserNotification
	(*ListUserNotificationsRequest)(nil),        // 27: memos.api.v1.ListUserNotificationsRequest
	(*ListUserNotificationsResponse)(nil),       // 28: memos.api.v1.ListUserNotificationsResponse
	(*UpdateUserNotificationRequest)(nil),       // 29: memos.api.v1.UpdateUserNotificationRequest
	(*DeleteUserNotificationRequest)(nil),       // 30: memos.api.v1.DeleteUserNotificationRequest
	nil,                                         // 31: memos.api.v1.UserStats.TagCountEntry
	(*UserStats_MemoTypeStats)(nil),             // 32: memos.api.v1.UserStats.MemoTypeStats
	(*UserSetting_GeneralSetting)(nil),          // 33: memos.api.v1.UserSetting.GeneralSetting
	(*UserSetting_WebhooksSetting)(nil),         // 34: memos.api.v1.UserSetting.WebhooksSetting
	(*UserSetting_TagMetadata)(nil),             // 35: memos.api.v1.UserSetting.TagMetadata
	(*UserSetting_TagsSetting)(nil),             // 36: memos.api.v1.UserSetting.TagsSetting
	nil,                                         // 37: memos.api.v1.UserSetting.TagsSetting.TagsEntry
	(*UserNotification_MemoCommentPayload)(nil), // 38: memos.api.v1.UserNotification.MemoCommentPayload
...
var file_api_v1_user_service_proto_depIdxs = []int32{
	...
	39, // 1: memos.api.v1.User.state:type_name -> memos.api.v1.State
	40, // 2: memos.api.v1.User.create_time:type_name -> google.protobuf.Timestamp
	40, // 3: memos.api.v1.User.update_time:type_name -> google.protobuf.Timestamp
	4,  // 4: memos.api.v1.ListUsersResponse.users:type_name -> memos.api.v1.User
	41, // 5: memos.api.v1.GetUserRequest.read_mask:type_name -> google.protobuf.FieldMask
	...
	41, // 8: memos.api.v1.UpdateUserRequest.update_mask:type_name -> google.protobuf.FieldMask
	40, // 9: memos.api.v1.UserStats.memo_display_timestamps:type_name -> google.protobuf.Timestamp
	32, // 10: memos.api.v1.UserStats.memo_type_stats:type_name -> memos.api.v1.UserStats.MemoTypeStats
	31, // 11: memos.api.v1.UserStats.tag_count:type_name -> memos.api.v1.UserStats.TagCountEntry
	11, // 12: memos.api.v1.ListAllUserStatsResponse.stats:type_name -> memos.api.v1.UserStats
	33, // 13: memos.api.v1.UserSetting.general_setting:type_name -> memos.api.v1.UserSetting.GeneralSetting
	34, // 14: memos.api.v1.UserSetting.webhooks_setting:type_name -> memos.api.v1.UserSetting.WebhooksSetting
	36, // 15: memos.api.v1.UserSetting.tags_setting:type_name -> memos.api.v1.UserSetting.TagsSetting
	15, // 16: memos.api.v1.UpdateUserSettingRequest.setting:type_name -> memos.api.v1.UserSetting
	41, // 17: memos.api.v1.UpdateUserSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	15, // 18: memos.api.v1.ListUserSettingsResponse.settings:type_name -> memos.api.v1.UserSetting
	40, // 19: memos.api.v1.UserWebhook.create_time:type_name -> google.protobuf.Timestamp
	40, // 20: memos.api.v1.UserWebhook.update_time:type_name -> google.protobuf.Timestamp
	20, // 21: memos.api.v1.ListUserWebhooksResponse.webhooks:type_name -> memos.api.v1.UserWebhook
	20, // 22: memos.api.v1.CreateUserWebhookRequest.webhook:type_name -> memos.api.v1.UserWebhook
	20, // 23: memos.api.v1.UpdateUserWebhookRequest.webhook:type_name -> memos.api.v1.UserWebhook
	41, // 24: memos.api.v1.UpdateUserWebhookRequest.update_mask:type_name -> google.protobuf.FieldMask
	2,  // 25: memos.api.v1.UserNotification.status:type_name -> memos.api.v1.UserNotification.Status
	40, // 26: memos.api.v1.UserNotification.create_time:type_name -> google.protobuf.Timestamp
	3,  // 27: memos.api.v1.UserNotification.type:type_name -> memos.api.v1.UserNotification.Type
	38, // 28: memos.api.v1.UserNotification.memo_comment:type_name -> memos.api.v1.UserNotification.MemoCommentPayload
	26, // 29: memos.api.v1.ListUserNotificationsResponse.notifications:type_name -> memos.api.v1.UserNotification
	26, // 30: memos.api.v1.UpdateUserNotificationRequest.notification:type_name -> memos.api.v1.UserNotification
	41, // 31: memos.api.v1.UpdateUserNotificationRequest.update_mask:type_name -> google.protobuf.FieldMask
	20, // 32: memos.api.v1.UserSetting.WebhooksSetting.webhooks:type_name -> memos.api.v1.UserWebhook
	42, // 33: memos.api.v1.UserSetting.TagMetadata.background_color:type_name -> google.type.Color
	37, // 34: memos.api.v1.UserSetting.TagsSetting.tags:type_name -> memos.api.v1.UserSetting.TagsSetting.TagsEntry
	35, // 35: memos.api.v1.UserSetting.TagsSetting.TagsEntry.value:type_name -> memos.api.v1.UserSetting.TagMetadata
	...
	21, // 46: memos.api.v1.UserService.ListUserWebhooks:input_type -> memos.api.v1.ListUserWebhooksRequest
	23, // 47: memos.api.v1.UserService.CreateUserWebhook:input_type -> memos.api.v1.CreateUserWebhookRequest
	24, // 48: memos.api.v1.UserService.UpdateUserWebhook:input_type -> memos.api.v1.UpdateUserWebhookRequest
	25, // 49: memos.api.v1.UserService.DeleteUserWebhook:input_type -> memos.api.v1.DeleteUserWebhookRequest
	27, // 50: memos.api.v1.UserService.ListUserNotifications:input_type -> memos.api.v1.ListUserNotificationsRequest
	29, // 51: memos.api.v1.UserService.UpdateUserNotification:input_type -> memos.api.v1.UpdateUserNotificationRequest
	30, // 52: memos.api.v1.UserService.DeleteUserNotification:input_type -> memos.api.v1.DeleteUserNotificationRequest
	6,  // 53: memos.api.v1.UserService.ListUsers:output_type -> memos.api.v1.ListUsersResponse
	4,  // 54: memos.api.v1.UserService.GetUser:output_type -> memos.api.v1.User
	4,  // 55: memos.api.v1.UserService.CreateUser:output_type -> memos.api.v1.User
	4,  // 56: memos.api.v1.UserService.UpdateUser:output_type -> memos.api.v1.User
	43, // 57: memos.api.v1.UserService.DeleteUser:output_type -> google.protobuf.Empty
	14, // 58: memos.api.v1.UserService.ListAllUserStats:output_type -> memos.api.v1.ListAllUserStatsResponse
	11, // 59: memos.api.v1.UserService.GetUserStats:output_type -> memos.api.v1.UserStats
	15, // 60: memos.api.v1.UserService.GetUserSetting:output_type -> memos.api.v1.UserSetting
	15, // 61: memos.api.v1.UserService.UpdateUserSetting:output_type -> memos.api.v1.UserSetting
	19, // 62: memos.api.v1.UserService.ListUserSettings:output_type -> memos.api.v1.ListUserSettingsResponse
	22, // 63: memos.api.v1.UserService.ListUserWebhooks:output_type -> memos.api.v1.ListUserWebhooksResponse
	20, // 64: memos.api.v1.UserService.CreateUserWebhook:output_type -> memos.api.v1.UserWebhook
	20, // 65: memos.api.v1.UserService.UpdateUserWebhook:output_type -> memos.api.v1.UserWebhook
	43, // 66: memos.api.v1.UserService.DeleteUserWebhook:output_type -> google.protobuf.Empty
	28, // 67: memos.api.v1.UserService.ListUserNotifications:output_type -> memos.api.v1.ListUserNotificationsResponse
	26, // 68: memos.api.v1.UserService.UpdateUserNotification:output_type -> memos.api.v1.UserNotification
	43, // 69: memos.api.v1.UserService.DeleteUserNotification:output_type -> google.protobuf.Empty
