...
const file_store_user_setting_proto_rawDesc = "" +
	"\n" +
	"\x18store/user_setting.proto\x12\vmemos.store\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/type/color.proto\"\x93\x04\n" +
	...
	"\x0erefresh_tokens\x18\b \x01(\v2%.memos.store.RefreshTokensUserSettingH\x00R\rrefreshTokens\x122\n" +
	"\x04tags\x18\n" +
	" \x01(\v2\x1c.memos.store.TagsUserSettingH\x00R\x04tags\"h\n" +
	"\x03Key\x12\x13\n" +
	"\x0fKEY_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aGENERAL\x10\x01\x12\r\n" +
	"\tSHORTCUTS\x10\x04\x12\f\n" +
	"\bWEBHOOKS\x10\x05\x12\x12\n" +
	"\x0eREFRESH_TOKENS\x10\x06\x12\b\n" +
	"\x04TAGS\x10\b\"\x04\b\a\x10\aB\a\n" +
	"\x05valueJ\x04\b\t\x10\n" +
	"\"k\n" +
	...
	"\abrowser\x18\x05 \x01(\tR\abrowser\"\xaa\x01\n" +
...
var file_store_user_setting_proto_goTypes = []any{
	...
	(*WebhooksUserSetting)(nil),                   // 5: memos.store.WebhooksUserSetting
	(*TagMetadata)(nil),                           // 6: memos.store.TagMetadata
	...
	nil,                                           // 12: memos.store.TagsUserSetting.TagsEntry
	(*color.Color)(nil),                           // 13: google.type.Color
...
var file_store_user_setting_proto_depIdxs = []int32{
	...
	5,  // 3: memos.store.UserSetting.webhooks:type_name -> memos.store.WebhooksUserSetting
	3,  // 4: memos.store.UserSetting.refresh_tokens:type_name -> memos.store.RefreshTokensUserSetting
	7,  // 5: memos.store.UserSetting.tags:type_name -> memos.store.TagsUserSetting
	8,  // 6: memos.store.RefreshTokensUserSetting.refresh_tokens:type_name -> memos.store.RefreshTokensUserSetting.RefreshToken
	10, // 7: memos.store.ShortcutsUserSetting.shortcuts:type_name -> memos.store.ShortcutsUserSetting.Shortcut
	11, // 8: memos.store.WebhooksUserSetting.webhooks:type_name -> memos.store.WebhooksUserSetting.Webhook
	13, // 9: memos.store.TagMetadata.background_color:type_name -> google.type.Color
	12, // 10: memos.store.TagsUserSetting.tags:type_name -> memos.store.TagsUserSetting.TagsEntry
	14, // 11: memos.store.RefreshTokensUserSetting.RefreshToken.expires_at:type_name -> google.protobuf.Timestamp
	14, // 12: memos.store.RefreshTokensUserSetting.RefreshToken.created_at:type_name -> google.protobuf.Timestamp
	...
	6,  // 14: memos.store.TagsUserSetting.TagsEntry.value:type_name -> memos.store.TagMetadata
