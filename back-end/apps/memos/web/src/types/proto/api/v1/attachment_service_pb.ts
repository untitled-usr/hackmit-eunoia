...
/**
 * AttachmentService manages attachment CRUD operations.
 * Fork: see common.proto package comment. Binary bytes are served via GET /file/attachments/... (fileserver), not gRPC body payloads.
 *
