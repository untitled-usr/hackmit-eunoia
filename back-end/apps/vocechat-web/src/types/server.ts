...
/** This fork removed GET `/api/admin/login/config`; the client needs a defined config or `RequireAuth` spins forever. */
export const FALLBACK_MEMOS_STYLE_LOGIN_CONFIG: LoginConfig = {
  who_can_sign_up: "EveryOne",
  password: true,
  magic_link: false,
  guest: false,
  google: false,
