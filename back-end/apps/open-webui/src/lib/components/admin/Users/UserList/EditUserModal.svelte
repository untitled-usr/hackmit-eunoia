<script lang="ts">
	...
	import { SYSTEM_ADMIN_USER_ID } from '$lib/constants';
						...
						<div class="flex self-center w-full">
							...
							<div class=" flex-1">
								...
								<div class=" flex flex-col space-y-1.5">
									...
									<div class="flex flex-col w-full">
										...
										<div class="flex-1">
											<select
												...
												required
											>
												{#if selectedUser?.id === SYSTEM_ADMIN_USER_ID}
									...
									<div class="flex flex-col w-full">
										<div class=" mb-1 text-xs text-gray-500">{$i18n.t('ID')}</div>
										<div class="flex-1 text-xs font-mono break-all text-gray-600 dark:text-gray-400">
											{selectedUser?.id}
										</div>
									</div>
