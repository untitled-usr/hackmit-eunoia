...
export const getGravatarURL = (identifier) => {
...
export const getPromptVariables = (user_name, user_location, user_id = '') => {
	return {
		'{{USER_NAME}}': user_name,
		'{{USER_EMAIL}}': user_id || 'Unknown',
