...
####################################
# Acting user header (primary authentication)
####################################

ACTING_USER_ID_HEADER = os.environ.get("ACTING_USER_ID_HEADER", "X-Acting-Uid")

# Legacy flag; password/OAuth login has been removed. Kept for config compatibility.
