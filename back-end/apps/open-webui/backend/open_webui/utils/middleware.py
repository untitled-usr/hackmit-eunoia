                ...
                if tool_id.startswith("server:mcp:"):
                    try:
                        ...
                        if auth_type == "bearer":
                            ...
                            log.warning(
                                "MCP auth_type 'session' is not supported; use bearer with a static key."
                            )
                            k = mcp_server_connection.get("key", "")
                            if k:
                            ...
                            log.warning(
                                "MCP auth_type 'oauth_2.1' has been removed; use bearer or none."
                            )
