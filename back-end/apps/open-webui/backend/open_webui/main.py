...
from open_webui.utils.auth import (
    ...
    get_admin_user,
    get_verified_user,
    get_user_from_acting_uid_header,
)
...
app.state.config.DISALLOW_USER_REGISTRATION = DISALLOW_USER_REGISTRATION
...
async def generate_messages(
    ...
    Authentication: Supports Authorization bearer token or acting user id
    header (X-Acting-Uid) resolved by backend auth middleware.
    """
...
async def get_app_config(request: Request):
    user = get_user_from_acting_uid_header(request)
    ...
    return {
        **({"onboarding": True} if onboarding else {}),
        "acting_user_id_header": ACTING_USER_ID_HEADER,
        "status": True,
        ...
        "features": {
            ...
            "disallow_user_registration": app.state.config.DISALLOW_USER_REGISTRATION,
