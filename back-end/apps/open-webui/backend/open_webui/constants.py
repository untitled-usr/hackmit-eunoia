...
class ERROR_MESSAGES(str, Enum):
    ...
    ADMIN_ROLE_NOT_ASSIGNABLE = (
        "A second administrator cannot be created; only the system admin account may have the admin role."
    )
...
# Single built-in system administrator (created at startup when no admin exists).
SYSTEM_ADMIN_USER_ID = "00000000-0000-4000-8000-000000000001"
