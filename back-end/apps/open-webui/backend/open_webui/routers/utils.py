...
@router.get("/gravatar")
async def get_gravatar(identifier: str, user=Depends(get_verified_user)):
    """Gravatar hash from an arbitrary identifier (use user id; legacy `email` query removed)."""
    return get_gravatar_url(identifier)
